...
class User(AbstractUser, TimeStampMixin):
    # TODO: Birthdate was originally pulled from MLH....do this?
    date_of_birth = models.DateField(null=True, blank=False, verbose_name='Date of Birth', help_text='MM-DD-YYYY')
