...
from ksu_events.events.views.other_views import HomeView, ViewModelsView, CreateModelsView, EditEventView, UserProfileView, ViewParticipantsView, AddSubeventView
...
urlpatterns = [
    ...
    path('subevent/', AddSubeventView.as_view(), name="add_subevent"),
