...
# Local
from student_events.events.forms import EventForm, SubEventForm
from student_events.events.models import Event, SubEvent
from student_events.events.views.mixins import OrganizerRequiredMixin
from student_events.registration.models.model_registrations import Registrations
...
class UserProfileView(LoginRequiredMixin, TemplateView):
    template_name = "student_events/user_profile.html"
...
class HomeView(TemplateView):
    template_name = 'student_events/home_page.html'
...
class ViewModelsView(LoginRequiredMixin, ListView):
    model = Event
    template_name = 'student_events/view_models.html'
...
class CreateModelsView(OrganizerRequiredMixin, CreateView):
    ...
    template_name = 'student_events/organizer_dash.html'
    ...
    def form_invalid(self, form):
        ...
        return render(self.request, 'student_events/view_models.html', context)
...
class EditEventView(OrganizerRequiredMixin,  UpdateView):
    model = Event
    form_class = EventForm
    template_name = 'student_events/edit_event.html'
...
class AddSubeventView(OrganizerRequiredMixin, CreateView):
    ...
    template_name = 'student_events/add_subevent.html'
    success_url = reverse_lazy('view_models')
...
class ViewSubEventsView(LoginRequiredMixin, ListView):
    model = SubEvent
    template_name = 'student_events/view_subevents.html'
...
class EditSubEventView(OrganizerRequiredMixin, UpdateView):
    model = SubEvent
    form_class = SubEventForm
    template_name = 'student_events/edit_subevent.html'
...
class ViewParticipantsView(LoginRequiredMixin, ListView):
    model = User
    template_name = 'student_events/view_participant.html'
